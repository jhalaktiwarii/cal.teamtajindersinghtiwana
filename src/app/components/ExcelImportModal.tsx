...
export default function ExcelImportModal({ open, onClose, onImportComplete }: ExcelImportModalProps) {
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      // If there are valid birthdays, import them directly
      ...
      <DialogContent className="max-w-4xl w-full p-0">
        <DialogHeader className="p-6 pb-2">
          <DialogTitle className="text-xl font-bold text-center">
            {showPreview ? 'Preview Birthdays' : 'Import Birthdays from Excel'}
          </DialogTitle>
        </DialogHeader>
            ...
            <div className="mt-4 p-4 rounded-lg border">
              ...
              <div className="text-sm space-y-1">
                <p className="text-green-600">
                  ✅ Successfully imported: {importResult.success} birthdays
                </p>
                ...
                {importResult.failed > 0 && (
                  <p className="text-red-600">
                    ❌ Failed to import: {importResult.failed} records
                  </p>
                )}
              </div>
